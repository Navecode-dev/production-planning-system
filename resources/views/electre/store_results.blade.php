...
@section('title', 'ELECTRE - Hasil Peringkat Toko')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Hasil Perhitungan ELECTRE untuk Toko</h3>
                <div class="card-tools">
                    <a href="{{ route('electre.store.index') }}" class="btn btn-secondary btn-sm">Kembali ke Perhitungan</a>
                </div>
            </div>
            <div class="card-body">
                @php renderMatrix('Langkah 0: Matriks Keputusan (Skor Awal)', $decisionMatrix, $stores, $criteria, 'Toko', '%.2f'); @endphp
                <div class="formula-section">
                    <h4>1. Matriks Keputusan Mentah (X)</h4>
                    <p class="formula-text">Matriks ini berisi skor mentah setiap toko terhadap setiap kriteria. Contoh representasi matriks:</p>
                ...
                @php renderMatrix('Langkah 1: Matriks Keputusan Ternormalisasi', $normalizedMatrix, $stores, $criteria, 'Toko'); @endphp
                <div class="formula-section">
                    ...
                    <p class="formula-text">Dimana x<sub>ij</sub> adalah skor mentah alternatif i pada kriteria j, dan m adalah jumlah alternatif.</p>
                </div>

                @php renderMatrix('Langkah 2: Matriks Ternormalisasi Terbobot', $weightedMatrix, $stores, $criteria, 'Toko'); @endphp
                <div class="formula-section">
                    ...
                    <p class="formula-text">Dimana w<sub>j</sub> adalah bobot kriteria j, dan r<sub>ij</sub> adalah nilai ternormalisasi.</p>
                </div>
                ...
                @php renderComparisonMatrix('Langkah 3 & 4a: Matriks Konkordansi (C)', $concordanceMatrix, $stores); @endphp
                <div class="formula-section">
                ...
                @php renderComparisonMatrix('Langkah 3 & 4b: Matriks Diskordansi (D)', $discordanceMatrix, $stores); @endphp
                <div class="formula-section">
                ...
                @php renderComparisonMatrix('Langkah 5a: Matriks Dominansi Konkordansi (F)', $concordanceDominance, $stores, '%d', $concordanceThreshold); @endphp
                <div class="formula-section">
                ...
                @php renderComparisonMatrix('Langkah 5b: Matriks Dominansi Diskordansi (G)', $discordanceDominance, $stores, '%d', $discordanceThreshold); @endphp
                <div class="formula-section">
                ...
                @php renderComparisonMatrix('Langkah 6: Matriks Dominansi Agregat (E)', $aggregateDominanceMatrix, $stores, '%d'); @endphp
                <div class="formula-section">
