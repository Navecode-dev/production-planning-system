...
<html>
<head>
    <title>Laporan Riwayat Perhitungan ELECTRE Toko</title>
    <style>
...
<body>
    <h3>Laporan Riwayat Perhitungan Peringkat Toko (ELECTRE)</h3>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @php
                                    ...
                                    arsort($ranking);
                                @endphp
                                @foreach (array_keys($ranking) as $rank => $storeName)
                                    <tr>
                                        <td>{{ $rank + 1 }}</td>
                                        <td>{{ $storeName }}</td>
